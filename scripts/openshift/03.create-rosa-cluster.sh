...
# Load subnet IDs from prior VPC tagging step
...
# Step 1: Create the public ROSA HCP cluster
...
# Step 2: Wait for cluster to become ready
...
# # Step 3: Restrict API and ingress access

# echo "🔐 Restricting access to: $ROSA_ALLOWED_CIDRS"

# rosa edit cluster \
#   --cluster "$ROSA_CLUSTER_NAME" \
#   --region "$ROSA_REGION" \
#   --profile "$ROSA_PROFILE" \
#   --api-allowed-cidrs "$ROSA_ALLOWED_CIDRS"

# rosa edit ingress default \
#   --cluster "$ROSA_CLUSTER_NAME" \
#   --region "$ROSA_REGION" \
#   --profile "$ROSA_PROFILE" \
#   --allowlist "$ROSA_ALLOWED_CIDRS"

#echo "✅ Public ROSA HCP cluster created and locked down."
echo "✅ Public ROSA HCP cluster created."

# Step 4: Patch AWS Sercuity groups to use local CIDR
...
# Get all ROSA security groups using api.openshift.com/name
