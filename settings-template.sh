...
# APPROVER POLICY
# helm
export JS_POLICY_APPROVER_VERSION := v0.7.2
# image
export JS_APPROVER_POLICY_ENTERPRISE_IMAGE_VERSION :=v0.7.2
...
# ENHANCED ISSUER
# helm
export JS_VENAFI_ENHANCED_ISSUER_VERSION := v0.3.2
# image
export JS_VENAFI_ENHANCED_ISSUER_IMAGE_VERSION :=v0.3.2
