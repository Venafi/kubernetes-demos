...
#Jetstack Secure Image versions
# CSI DRIVER Images
export JS_CERT_MANAGER_CSI_DRIVER_IMAGE_VERSION :=v0.4.0
export JS_CSI_NODE_DRIVER_REGISTRAR_IMAGE_VERSION :=v2.6.2
export JS_LIVENESSPROBE_IMAGE_VERSION :=v2.8.0

#CSI SPIFFE DRIVER
export JS_CERT_MANAGER_CSI_DRIVER_SPIFFE_IMAGE_VERSION :=v0.2.0
export JS_CERT-MANAGER_CSI_DRIVER_SPIFFE_APPROVER_IMAGE_VERSION :=v0.2.0
...
export JS_APPROVER_POLICY_ENTERPRISE_IMAGE_VERSION :=v0.4.0-0

# ENTERPRISE CERT MANAGER
export JS_CERT_MANAGER_CONTROLLER_IMAGE_VERSION :=v1.10.1
export JS_CERT_MANAGER_WEBHOOK_IMAGE_VERSION :=v1.10.1
export JS_CERT_MANAGER_CAINJECTOR_IMAGE_VERSION :=v1.10.1
export JS_CERT_MANAGER_CTL_IMAGE_VERSION :=v1.10.1

#TRUST
export JS_TRUST_MANAGER_IMAGE_VERSION :=v0.3.0
