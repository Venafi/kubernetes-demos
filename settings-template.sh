...
# helm
export JS_CERT_MANAGER_VERSION := v1.12.4
# images
export JS_CERT_MANAGER_CONTROLLER_IMAGE_VERSION :=v1.12.4
export JS_CERT_MANAGER_WEBHOOK_IMAGE_VERSION :=v1.12.4
export JS_CERT_MANAGER_CAINJECTOR_IMAGE_VERSION :=v1.12.4
export JS_CERT_MANAGER_CTL_IMAGE_VERSION :=v1.12.4

# TRUST MANAGER versions
# helm
export JS_CERT_MANAGER_TRUST_VERSION= v0.5.0
# image
export JS_TRUST_MANAGER_IMAGE_VERSION :=v0.5.0

# APPROVER POLICY
# helm
export JS_POLICY_APPROVER_VERSION := v0.9.0
# image
export JS_APPROVER_POLICY_ENTERPRISE_IMAGE_VERSION :=v0.9.0
...
# CSI SPIFFE DRIVER
# helm
export JS_CERT_MANAGER_CSI_DRIVER_SPIFFE_VERSION :=v0.4.0
# image
export JS_CERT_MANAGER_CSI_DRIVER_SPIFFE_IMAGE_VERSION :=v0.4.0
export JS_CERT-MANAGER_CSI_DRIVER_SPIFFE_APPROVER_IMAGE_VERSION :=v0.4.0

# ENHANCED ISSUER
# helm
export JS_VENAFI_ENHANCED_ISSUER_VERSION := v0.5.0
# image
export JS_VENAFI_ENHANCED_ISSUER_IMAGE_VERSION :=v0.5.0

# JS OPERATOR
# helm
export JS_OPERATOR_VERSION :=v0.0.1-alpha.28
# image
export JS_OPERATOR_IMAGE_VERSION :=v0.0.1-alpha.28
...
# ISTIO CSR
# helm
export JS_CERT_MANAGER_ISTIO_CSR_VERSION :=v0.7.0
# image
export JS_CERT_MANAGER_ISTIO_CSR_IMAGE_VERSION :=v0.7.0

# Istio version
export JS_ISTIO_VERSION :=1.17.2
