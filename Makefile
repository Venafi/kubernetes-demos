...
cluster-addons-all: cluster-addons install-cert-sync-to-venafi-module install-cert-manager-csi-driver install-cert-manager-csi-driver-spiffe install-js-venafi-enhanced-issuer-module
